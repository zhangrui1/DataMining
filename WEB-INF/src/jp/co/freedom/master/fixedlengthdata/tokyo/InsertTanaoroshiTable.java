 ...
 *
 */
@WebServlet(name = "InsertTanaoroshiTable", urlPatterns = { "/InsertTanaoroshiTable" })
@MultipartConfig(fileSizeThreshold = 5000000, maxFileSize = 10000000)
public class InsertTanaoroshiTable extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			TanaoroshiTableUtil.resetDB(conn); // DBの初期化
			TanaoroshiTableUtil.importData(conn, csvData); // データインポート
