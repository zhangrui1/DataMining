 ...
 *
 */
@WebServlet(name = "MasterAppDataWithRfidDLForMesago", urlPatterns = { "/MasterAppDataWithRfidDLForMesago" })
public class MasterAppDataWithRfidDLForMesago extends HttpServlet {
