 ...
 *
 */
@WebServlet(name = "MasterPreDataWithRfidDLForMesago", urlPatterns = { "/MasterPreDataWithRfidDLForMesago" })
public class MasterPreDataWithRfidDLForMesago extends HttpServlet {
