 ...
 * 
 */
public class ImeValidator extends Validator {
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			 ...
			 * 必須制約違反の検証
			 */
			ImeUtil util = new ImeUtil();
			// 氏名情報
			boolean V_NAME1 = StringUtil.isNotEmpty(userdata.cardInfo.V_NAME1);
			boolean V_NAME2 = ImeUtil.isOversea((ImeUserDataDto) userdata)
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = ImeUtil
					.isOversea((ImeUserDataDto) userdata) ? V_ADDR2 : V_ZIP
