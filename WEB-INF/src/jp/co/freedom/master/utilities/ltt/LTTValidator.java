 ...
 *
 */
public class LTTValidator extends Validator {
	 ...
	 *            不明マーク
	 */
	public LTTValidator(String mark) {
		super();
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			...
			boolean V_NAME2 = "1".equals(userdata.cardInfo.V_OVERSEA) || util.isPreEntry(userdata) ? true
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = LTTExhibitorUtil
					.isOversea((LttUserDataDto) userdata) ? V_ADDR2 : V_ZIP
