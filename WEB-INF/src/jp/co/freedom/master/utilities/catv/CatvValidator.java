 ...
 *
 */
public class CatvValidator extends Validator {
	 ...
	 *            不明マーク
	 */
	public CatvValidator(String mark) {
		super();
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			...
			boolean V_NAME2 = util.isAppEntry(userdata) ? StringUtil
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = CatvUtil
					.isOversea((CatvUserDataDto) userdata) ? V_ADDR2 : V_ZIP
					&& V_ADDR;
