...
public class JecaConfig {
	...
	public static final String PSQL_URL_REMOTE = "jdbc:mysql://118.22.30.75:63306/jeca2014?useUnicode=true&characterEncoding=utf8";
	// public static final String PSQL_URL_REMOTE =
	...
	/** データフォルダ */
	public static final String barcodeDataDirectory = "f:\\matching\\jeca";
	/** 事前バーコードと登録番号対応表 */
	public static final String CONVERT_TABLE_DIRECTORY = "f:\\matching\\jecaConvertTable";
	...
	//
	// /** 開催日 */
	// public static final String[] DAYS = { "19", "20", "21" };
	//
	// /** 開場時間 */
