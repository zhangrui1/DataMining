 ...
 * 
 */
public class BasfValidator extends Validator {

	/** コンストラクタ */
	public BasfValidator() {
		super();
	}
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			...
			boolean V_NAME2 = BasfUtil.isOversea((BasfUserDataDto) userdata) ? true
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = BasfUtil
					.isOversea((BasfUserDataDto) userdata) ? V_ADDR2 : V_ZIP
