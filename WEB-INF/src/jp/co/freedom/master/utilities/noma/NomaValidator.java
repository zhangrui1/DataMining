 ...
 *
 */
public class NomaValidator extends Validator {
	 ...
	 *            不明マーク
	 */
	public NomaValidator(String mark) {
		super();
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			...
			boolean V_NAME2 = NomaUtil.isOversea((NomaUserDataDto) userdata)
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = NomaUtil
					.isOversea((NomaUserDataDto) userdata) ? V_ADDR2 : V_ZIP
