 ...
 *
 */
public class NomaConfig {

	// ◆◆◆MySQL接続情報◆◆◆
	/** DBサーバーURL */
	public static final String PSQL_URL_REMOTE = "jdbc:mysql://118.22.30.75:63306/modarn?useUnicode=true&characterEncoding=utf8";
	public static final String PSQL_URL_LOCAL = "jdbc:mysql://localhost:3306/modarn?useUnicode=true&characterEncoding=utf8";
	...
	// /** データフォルダ */
	// public static final String barcodeDataDirectory = "f:\\matching\\noma";
	// /** データフォルダ(出展社納品データ) */
	// public static final String barcodeDataDirectoryNomaExhibitor =
	// "f:\\matching\\noma_exhibitor";
	// /** 事前バーコードと登録番号対応表 */
	// public static final String CONVERT_TABLE_DIRECTORY =
	// "f:\\matching\\nomaConvertTable";
	...
	// ◆◆◆展示会情報◆◆◆
	/** 展示会名称 */
	public static final String EXHIBITION_NAME = "IL/IFFT";
	...
	/** 開催日 */
	public static final String[] DAYS = { "4", "5", "6" };

	/** 開催日 */
	public static final String[] DAYS2 = { "04", "05", "06" };
