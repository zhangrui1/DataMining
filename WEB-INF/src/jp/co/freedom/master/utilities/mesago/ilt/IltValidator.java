 ...
 *
 */
public class IltValidator extends Validator {
	 ...
	 *            不明マーク
	 */
	public IltValidator(String mark) {
		super();
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			...
			boolean V_NAME2 = IltUtil.isOversea((MesagoUserDataDto) userdata)
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = IltUtil
