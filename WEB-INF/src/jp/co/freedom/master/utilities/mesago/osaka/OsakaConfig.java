...
public class OsakaConfig {
	...
	/** データフォルダ */
	public static final String barcodeDataDirectory = "d:\\zui\\Freedom\\matching\\rfid";
	/** 事前バーコードと登録番号対応表 */
	public static final String CONVERT_TABLE_DIRECTORY = "d:\\zui\\Freedom\\OSAKA\\mesagoConvertTable";
	...
	/** 事前登録(来場者)マスターデータファイル */
	public static final String PREENTRY_MASTERFILE_NAME = "事前登録_来場者.txt";

	/** 事前登録(未来場者)マスターデータファイル */
	public static final String PREENTRY_NONVISITOR_MASTERFILE_NAME = "事前登録_未来場者.txt";
