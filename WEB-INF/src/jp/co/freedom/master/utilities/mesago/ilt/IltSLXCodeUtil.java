...
/**
 * 【ILT】SLXコードユーティリティクラス
 * 
 * @author フリーダム・グループ
 * 
 */
public class IltSLXCodeUtil {

	/** 展示会名称：ILT */
	public static final String IL = "IL/IFFT";
	...
	private static Map<String, MesagoSLXDto> createAccOfStaffMap() {
		...
		info.setAccOfStaffInfo("1～5", "5");
		map.put("1", info);

		info = new MesagoSLXDto();
		info.setAccOfStaffInfo("6～20", "20");
		map.put("2", info);

		info = new MesagoSLXDto();
		info.setAccOfStaffInfo("21～50", "50");
		map.put("3", info);

		info = new MesagoSLXDto();
		info.setAccOfStaffInfo("51～100", "100");
		map.put("4", info);

		info = new MesagoSLXDto();
		info.setAccOfStaffInfo("101～500", "500");
		map.put("5", info);

		info = new MesagoSLXDto();
		info.setAccOfStaffInfo("501～1000", "1000");
		map.put("6", info);

		info = new MesagoSLXDto();
		info.setAccOfStaffInfo("1001～", "1001");
		map.put("7", info);
	...
	private static Map<String, MesagoSLXDto> createContactPostTypeMap() {
		...
		info = new MesagoSLXDto();
		info.setContactPostTypeInfo("デザイナー", "PT1");
		map.put("2", info);
	...
	private static Map<String, MesagoSLXDto> createContactPostGroupMap() {
		...
		info = new MesagoSLXDto();
		info.setContactPostGroupInfo("経営者・役員・オーナー", "PG0");
		map.put("1", info);
