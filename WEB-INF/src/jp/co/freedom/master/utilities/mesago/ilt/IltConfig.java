 ...
 *
 */
public class IltConfig {

	// ◆◆◆MySQL接続情報◆◆◆
	/** DBサーバーURL */
	public static final String PSQL_URL_REMOTE = "jdbc:mysql://118.22.30.75:63306/ilf2014?useUnicode=true&characterEncoding=utf8";
	...
	/** データフォルダ */
	public static final String barcodeDataDirectory = "f:\\matching\\ilt";

	/** データフォルダ */
	public static final String barcodeDataDirectoryIltExhibitor = "f:\\matching\\ilt_exhibitor";

	/** ダブルコーテーションによるエンクォートが施されているか否かのブール値 */
	/** 事前バーコードと登録番号対応表 */
	public static final String CONVERT_TABLE_DIRECTORY = "f:\\matching\\iltConvertTable";
	/** ダブルコーテーションによるエンクォートが施されているか否かのブール値 */
