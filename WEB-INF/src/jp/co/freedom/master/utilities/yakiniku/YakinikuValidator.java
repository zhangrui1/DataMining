 ...
 * 
 */
public class YakinikuValidator extends Validator {

	/** コンストラクタ */
	public YakinikuValidator() {
		super();
	}
	...
	public void validate(UserDataDto userdata, String validationType) {
		...
		if ("1".equals(validationType)) {
			 ...
			 * 必須制約違反の検証
			 */
			YakinikuUtil util = new YakinikuUtil();
			// 氏名情報
			boolean V_NAME1 = StringUtil.isNotEmpty(userdata.cardInfo.V_NAME1);
			boolean V_NAME2 = YakinikuUtil.isOversea((YakinikuUserDataDto) userdata)
			...
			// 連絡先情報の欠落フラグ
			boolean addressIsValid = YakinikuUtil
					.isOversea((YakinikuUserDataDto) userdata) ? V_ADDR2 : V_ZIP
