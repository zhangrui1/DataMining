...
/**
 * 【汎用】速報集計 DBデータアップロードサーブレット
 *
 * @author フリーダム・グループ
 *
 */
@MultipartConfig(fileSizeThreshold = 5000000, maxFileSize = 10000000)
public class UploadRfidDataForGeneralPurposePromptReport extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Utilities.initializeRfidTable(conn, unique, config.days.length); // RFIDテーブルにユニークバーコード番号を登録する
