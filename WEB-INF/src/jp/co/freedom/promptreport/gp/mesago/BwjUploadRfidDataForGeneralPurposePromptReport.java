 ...
 *
 */
@WebServlet(name = "BwjUploadRfidDataForGeneralPurposePromptReport", urlPatterns = { "/BwjUploadRfidDataForGeneralPurposePromptReport" })
@MultipartConfig(fileSizeThreshold = 5000000, maxFileSize = 10000000)
public class BwjUploadRfidDataForGeneralPurposePromptReport extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// バーコードデータ
		List<BarcodeDto> barcodes = Utilities.createBwjInstance(allData);
		// ユニークIDの抽出
		...
		try {
			...
			Utilities.bwjInitializeRfidTable(conn, unique, config); // RFIDテーブルにユニークバーコード番号を登録する
