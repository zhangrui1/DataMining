 ...
 *
 */
@WebServlet(name = "NewRelationTable", urlPatterns = { "/NewRelationTable" })
@MultipartConfig(fileSizeThreshold = 5000000, maxFileSize = 10000000)
public class NewRelationTable extends HttpServlet {
...
//				List<ValdacBuhiDto> kikiList = new ArrayList<ValdacBuhiDto>();
